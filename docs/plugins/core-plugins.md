...
```ts
import { DocumentAgent, parseDocx, processTemplate } from '@giantanalyticsai/docx-js-editor/headless';
```
...
import { processTemplate } from '@giantanalyticsai/docx-js-editor/headless';
...
import {
  ...
  getTemplateTags,
  validateTemplate,
} from '@giantanalyticsai/docx-js-editor/headless';
...
```ts
import type { CorePlugin, PluginCommand } from '@giantanalyticsai/docx-js-editor';
import type { Document } from '@giantanalyticsai/docx-js-editor';
...
```ts
import { pluginRegistry } from '@giantanalyticsai/docx-js-editor';
...
// Batch registration
import { registerPlugins } from '@giantanalyticsai/docx-js-editor';
...
```ts
import { pluginRegistry, docxtemplaterPlugin } from '@giantanalyticsai/docx-js-editor';
