 ...
 * @example
 * ```ts
 * import { pluginRegistry } from '@giantanalyticsai/docx-editor/core-plugins';
 * import { docxtemplaterPlugin } from '@giantanalyticsai/docx-editor/core-plugins/docxtemplater';
 *
