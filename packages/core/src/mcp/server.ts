 ...
 * @example
 * ```ts
 * import { createMcpServer, startStdioServer } from '@giantanalyticsai/docx-editor/mcp';
 * import { pluginRegistry, docxtemplaterPlugin } from '@giantanalyticsai/docx-editor/core-plugins';
 *
 * // Register plugins
