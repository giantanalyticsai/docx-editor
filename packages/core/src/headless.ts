 ...
 * @example
 * ```ts
 * import { DocumentAgent, parseDocx, pluginRegistry } from '@giantanalyticsai/docx-editor/headless';
 * import { docxtemplaterPlugin } from '@giantanalyticsai/docx-editor/core-plugins';
 *
 * // Register plugins
