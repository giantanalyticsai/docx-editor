...
Separate package (`@giantanalyticsai/docx-editor-agents`) under BSL-1.1 — source-available, free for non-production, paid subscription for commercial use.

## What Changes

- **New package** `packages/agent-use/` → `@giantanalyticsai/docx-editor-agents` (BSL-1.1)
...
- **Peer dependency**: `@giantanalyticsai/docx-core` — no code duplication
