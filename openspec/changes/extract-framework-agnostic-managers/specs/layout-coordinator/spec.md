...
The `LayoutCoordinator` class SHALL import only from `@giantanalyticsai/docx-core` internals and vanilla DOM APIs. It SHALL NOT import React, Vue, or any framework.
